...
PROGRAM Cardiac_bioenergetics
  ...
  !PCr  (Creatine phosphate or Phosphocreatine)
  ...
  !CMISS variables
  !setting up fields for reaction diffusion equations.
...
!_________________________________________________________________________________________________
  ...
  ELSE
    ...
    READ(9,*) !Node file name, Element file name
    READ(9,*) NODEFILE,ELEMFILE
    READ(9,*) !comment
    READ(9,*) simplex_order
    READ(9,*) !ATP intial value, ATP diffusvity in X, ATP diffusvity in Y, ATP diffusvity in Z 
    READ(9,*) init_ATP,ATPDiffx,ATPDiffy,ATPDiffz
    READ(9,*) !ADP intial value, ADP diffusvity in X, ADP diffusvity in Y, ADP diffusvity in Z 
...
!________________________________________________________________________________________________________
  ...
  !Set the geometric field values, 0.1 micron/pixel is resolution of the mesh

  DO i = 1,NUMBER_OF_NODES
    node = NodeNums(i,1)
    CALL cmfe_Decomposition_NodeDomainGet(Decomposition,node,1,NodeDomain,Err)
    IF(NodeDomain==ComputationalNodeNumber) THEN
      nodex = NodeCoords(i,1)*0.1 
      nodey = NodeCoords(i,2)*0.1
...
!Create ATP  reaction diffusion with constant source equations_set 
  ...
  !Set diffusivity of ATP in both mitochondrial and myofibrils
  ...
  !Set diffusivity of ATP in mitochondrial to be 1/10th of myofibrils
    DO i = 1,NUMBER_OF_NODES
      ...
      CALL cmfe_Decomposition_NodeDomainGet(Decomposition,NodeNums(i,1),1,NodeDomain,Err)
       IF(NodeDomain==ComputationalNodeNumber) THEN
        CALL cmfe_Field_ParameterSetUpdateNode(ATPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),1,0.1_CMISSDP*ATPDiffx,Err)
         CALL cmfe_Field_ParameterSetUpdateNode(ATPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),2,0.1_CMISSDP*ATPDiffy,Err)
       ENDIF
     ENDIF
  ENDDO
      ...
      CALL cmfe_Decomposition_NodeDomainGet(Decomposition,NodeNums(i,1),1,NodeDomain,Err)
       IF(NodeDomain==ComputationalNodeNumber) THEN
        CALL cmfe_Field_ParameterSetUpdateNode(ADPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),1,0.1_CMISSDP*ADPDiffx,Err)
         CALL cmfe_Field_ParameterSetUpdateNode(ADPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),2,0.1_CMISSDP*ADPDiffy,Err)
       ENDIF
     ENDIF
  ENDDO
      ...
      CALL cmfe_Decomposition_NodeDomainGet(Decomposition,NodeNums(i,1),1,NodeDomain,Err)
       IF(NodeDomain==ComputationalNodeNumber) THEN
        CALL cmfe_Field_ParameterSetUpdateNode(AMPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),1,0.1_CMISSDP*AMPDiffx,Err)
         CALL cmfe_Field_ParameterSetUpdateNode(AMPMaterialsField,cmfe_FIELD_U_VARIABLE_TYPE, &
              & cmfe_FIELD_VALUES_SET_TYPE,1,1,NodeNums(i,1),2,0.1_CMISSDP*AMPDiffy,Err)
       ENDIF
     ENDIF
  ENDDO
...
!Start to set up CellML Fields
  ...
  CALL cmfe_CellML_ModelImport(CellML,"mitochondria_control.cellml",MitocondriaIndex,Err)
  ...
  !ATP, ADP and Pi in mitochondrial matrix  		  
  ...
  !Protonmotive force in mitochondria  		  	  
  ...
  ! First couple the mitochondrial reactions
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,ATPField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"ATP/ATP",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"ATP/ATP",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,ADPField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"ADP/ADP",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"ADP/ADP",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,AMPField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"AMP/AMP",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"AMP/AMP",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,PCrField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"PCr/PCr",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"PCr/PCr",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,CrField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"Cr/Cr",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"Cr/Cr",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,PiField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
    & MitocondriaIndex,"Pi/Pi",cmfe_FIELD_VALUES_SET_TYPE,Err)
  CALL cmfe_CellML_CreateCellMLToFieldMap(CellML,MitocondriaIndex,"Pi/Pi",cmfe_FIELD_VALUES_SET_TYPE, &
  ...
  ! Next couple the myofibrils reactions
  CALL cmfe_CellML_CreateFieldToCellMLMap(CellML,ATPField,cmfe_FIELD_U_VARIABLE_TYPE,1,cmfe_FIELD_VALUES_SET_TYPE, &
...
!Create the equations set equations for DPsi
 ...
 CALL cmfe_Problem_CreateStart(ProblemUserNumber,[CMFE_PROBLEM_CLASSICAL_FIELD_CLASS, &
  ...
  ! Note that we are not simulating Diffusion of membrane potential
  ! Also Oxygen consumption is assumed to be zero in the CellML model
...
!_________________________________________________________________________________________________________
  ...
  !No exchange of ATP,ADP,AMP,PCr,Cr and Pi across the cell membrane
  !Constant Oxygen level in the cell membrane
